...
3. **Build, screenshot, and deliver the screenshot to my phone — always.** Use the `app-preview` skill at `.claude/skills/app-preview/scripts/`:
   - `.claude/skills/app-preview/scripts/launch.sh` (full rebuild — this is the whole point)
