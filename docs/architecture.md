...
flowchart TD
  ...
  IOS["ios-dev — 23 skills · 6 cmds · 1 hook"]
  LIN["linear-pm — 1 skill · 6 cmds"]
  CW["core-workflow — 4 skills · 4 cmds · 2 agents · 1 hook"]
...
| `core-workflow` | everyday glue | commit, contribute, learn-lesson, branch-explainer skills; `/team`, `/contribute-skill`, `/learn`, `/explain-branch`; image-parser + web-researcher agents; shellcheck-on-edit hook |
